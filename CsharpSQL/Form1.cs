...
namespace CsharpSQL
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=NURANDUNDAR;Initial Catalog=projeee;Integrated Security=True");
        ...
        {// KAYDET TUŞU
            ...
            {               
                    SqlCommand komut = new SqlCommand("insert into projemm(personel_ıd,sicil_no,tc,ad,soyad,geçmiş yıla ait izin)values('" + textBox1.Text.ToString() + "','" + textBox2.Text.ToString() + "','" + comboBox1.Text.ToString() + "','" + textBox3.Text.ToString() + "','" + textBox4.Text.ToString() + "')", baglanti);
